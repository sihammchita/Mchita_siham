...
class ActeursControllerTest extends WebTestCase
{
    ...
    private ActeursRepository $repository;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Acteurs::class);
    ...
    public function testIndex(): void
    {
        ...
        self::assertPageTitleContains('Acteur index');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'acteur[date_naissance]' => 'Something New',
            'acteur[role]' => 'Something New',
        ]);
